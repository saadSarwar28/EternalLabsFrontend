...
export const EcLotteryCard = () => {
    ...
    return (
        <div className={styles.mintCard}>
            <p className={styles.mintCardAnnouncement}>Eternal Zombies Lottery!</p>
            <p className={styles.mintCardTotalMinted}>Try your luck and get an EZ token for just $5</p>
